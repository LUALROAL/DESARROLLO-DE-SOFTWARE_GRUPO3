...
public class ProductoController {
    ...
    @PreAuthorize("hasRole('ADMIN')")
    @PostMapping("/guardar")
    public ModelAndView crear(@RequestParam String nombre, @RequestParam float precioCompra, @RequestParam float precioVenta, @RequestParam int cantidad) {
        ModelAndView mv = new ModelAndView();
        ...
        Producto producto = new Producto(0, nombre, "", "", precioCompra, precioVenta, 19f, cantidad);
    ...
    public ModelAndView actualizar(@RequestParam int id, @RequestParam String nombre, @RequestParam float precioCompra, @RequestParam float precioVenta,
